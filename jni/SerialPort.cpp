    ...
    #include <string.h>  
    #include <jni.h>  
    #include "com_mitac_i2c_SerialPort.h"
     ...
     */  
    JNIEXPORT jobject JNICALL Java_com_mitac_i2c_SerialPort_open(JNIEnv *env, jobject thiz, jstring path,jint baudrate) {  
        int fd;  
        speed_t speed;  
     ...
     * Signature: ()V 
     */  
    JNIEXPORT jint JNICALL Java_com_mitac_i2c_SerialPort_close(JNIEnv * env, jobject thiz)  
    {  
...
/*
    static JNINativeMethod gMethods[] = {  
            { "open", "(Ljava/lang/String;I)Ljava/io/FileDescriptor;",
                      (void*)com_mitac_i2c_SerialPort_open },
            { "close", "()I",
                      (void*)com_mitac_i2c_SerialPort_close },
    };  
    ...
    static int registerNatives(JNIEnv* env) {  
        const char* kClassName = "com/mitac/i2c/SerialPort";
